...
namespace Plutus.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250308210340_RequisitionsIdGoCardlessMigration")]
    partial class RequisitionsIdGoCardlessMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Plutus.Infrastructure.Data.Entities.DataMigration", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("DataMigrations", "plutus");
                });
            ...
            modelBuilder.Entity("Plutus.Infrastructure.Data.Entities.Requisition", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.Property<string>("GoCardlessRequisitionId")
                        .IsRequired()
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("Plutus.Infrastructure.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
