...
namespace Plutus.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250212183621_RenameDebtorMigration")]
    partial class RenameDebtorMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Plutus.Infrastructure.Data.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("Plutus.Infrastructure.Data.Entities.Obligor", "Creditor")
                        .WithMany()
                        .HasForeignKey("CreditorId");

                    b.HasOne("Plutus.Infrastructure.Data.Entities.Obligor", "Debtor")
                        .WithMany()
