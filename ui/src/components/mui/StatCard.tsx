...
export type StatCardProps = {
  ...
  value: string;
  interval: string;
  trend: { color: "up" | "down" | "neutral"; label: string };
  data: number[];
};
...
export default function StatCard({
  ...
  const chartColor = trendColors[trend.color];
        ...
        >
          <Stack sx={{ justifyContent: "space-between" }}>
            ...
            >
              ...
              {/* <Chip size="small" color={color} label={trend.label} /> */}
            </Stack>
          ...
          <Box sx={{ width: "100%", height: 50 }}>
            ...
            >
              <AreaGradient
                color={chartColor}
                id={`area-gradient-${value.replace(" ", "-")}`}
              />
            </SparkLineChart>
          </Box>
        </Stack>
